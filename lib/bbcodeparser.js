(function(root, factory) {
  ...
  CodeTag = (function(_super) {
    ...
    CodeTag.prototype.format = "<div class=\"code\">%content%</div>";
  ...
  MonotypeTag = (function(_super) {
    __extends(MonotypeTag, _super);
  
    function MonotypeTag() {
      return MonotypeTag.__super__.constructor.apply(this, arguments);
    }
  
    MonotypeTag.prototype.tag = "m";
  
    MonotypeTag.prototype.name = "monotype";
  
    MonotypeTag.prototype.format = "<div class=\"code\">%content%</div>";
